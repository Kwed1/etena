...
export default function FourSection() {
	...
	useEffect(() => {
		...
		const tl = gsap.timeline({
			scrollTrigger: {
				...
				scrub: true,
				onUpdate: () => {
					const pinSpacer = (document.querySelector('.four-section') as Element)
		...
		if (deviceType === DeviceType.TABLET) {
			...
			tl.from('.js-four-contain-1', { y: 1000 })
				.to('.js-four-contain-1', { y: 200 })
				.to('.js-four-contain-1', { y: -1500 }, '+=4')
			tl.from('.js-four-contain-2', { y: 1000 })
				.to('.js-four-contain-2', { y: -500 })
				.to('.js-four-contain-2', { y: -1500 }, '+=4')
			...
			tl.fromTo(
				...
				'.js-four-contain-3',
				{ opacity: 0.5, visibility: 'visible', duration: 2 },
				'+=1'
			)
			tl.from('.js-four-cloud-2', { x: 0, y: 1000 }, '<0.1')
				.to('.js-four-cloud-2', { x: 150, y: -500 })
				.to('.js-four-cloud-2', { x: 100, y: -1000 })
			tl.to('.js-four-planet-1', { duration: 1, opacity: 0, y: '0%' })
				.to('.js-four-planet-1', { duration: 1, opacity: 0.5, y: '-400%' })
				.to('.js-four-planet-1', { duration: 1, opacity: 1, y: '-400%' })
				.to(
					'.js-four-planet-1',
					{ duration: 1, opacity: 0, y: '-1120%' },
					'+=4'
				)
			tl.to('.js-four-planet-2', { duration: 1, opacity: 0, y: '0%' })
				.to('.js-four-planet-2', { duration: 1, opacity: 0.5, y: '-400%' })
				.to('.js-four-planet-2', { duration: 1, opacity: 1, y: '-480%' })
				.to(
					'.js-four-planet-2',
					{ duration: 1, opacity: 0, y: '-1120%' },
					'+=4'
				)
			tl.to('.js-four-planet-3', { duration: 1, opacity: 0, y: '0%' })
				.to('.js-four-planet-3', { duration: 1, opacity: 0.5, y: '-400%' })
				.to('.js-four-planet-3', { duration: 1, opacity: 1, y: '-630%' })
				.to(
					'.js-four-planet-3',
					{ duration: 1, opacity: 0, y: '-1120%' },
					'+=4'
				)
			tl.to('.js-four-planet-4', { duration: 1, opacity: 0, y: '0%' })
				.to('.js-four-planet-4', { duration: 1, opacity: 0.5, y: '-400%' })
				.to('.js-four-planet-4', { duration: 1, opacity: 1, y: '-740%' })
				.to(
					'.js-four-planet-4',
					{ duration: 1, opacity: 0, y: '-1120%' },
					'+=4'
			...
			gsap.fromTo(
				'.four-section__planet-img--i1 img',
				{ y: -70, opacity: 0 },
				{
					y: 0,
					opacity: 1,
			...
			gsap.fromTo(
				'.four-section__planet-img--i2 img',
				{ y: -70, opacity: 0 },
				{
					y: 0,
					opacity: 1,
			...
			gsap.fromTo(
				'.four-section__planet-img--i3 img',
				{ y: -70, opacity: 0 },
				{
					y: 0,
					opacity: 1,
			...
			gsap.fromTo(
				'.four-section__planet-img--i4 img',
				{ y: -70, opacity: 0 },
				{
					y: 0,
					opacity: 1,
			...
			tl.from('.js-four-contain-1', { y: 1000 })
				.to('.js-four-contain-1', { y: 50 })
				.to('.js-four-contain-1', { y: -1500 }, '+=4')
			tl.from('.js-four-contain-2', { y: 1000 })
				.to('.js-four-contain-2', { y: -570 })
				.to('.js-four-contain-2', { y: -1500 }, '+=4')
			tl.fromTo('.js-four-cloud-1', { y: 0 }, { y: -1500 }, '<0.2')
			tl.fromTo(
				'.js-four-contain-3',
			...
			tl.to('.js-four-planet-1', { duration: 1, opacity: 0, y: '0%' })
				.to('.js-four-planet-1', { duration: 1, opacity: 0.5, y: '-400%' })
				.to('.js-four-planet-1', { duration: 1, opacity: 1, y: '-520%' })
				.to(
					'.js-four-planet-1',
					{ duration: 1, opacity: 0, y: '-1120%' },
					'+=4'
			...
			tl.to('.js-four-planet-2', { duration: 1, opacity: 0, y: '0%' })
				.to('.js-four-planet-2', { duration: 1, opacity: 0.5, y: '-400%' })
				.to('.js-four-planet-2', { duration: 1, opacity: 1, y: '-520%' })
				.to(
					'.js-four-planet-2',
					{ duration: 1, opacity: 0, y: '-1120%' },
					'+=4'
			...
			tl.to('.js-four-planet-3', { duration: 1, opacity: 0, y: '0%' })
				.to('.js-four-planet-3', { duration: 1, opacity: 0.5, y: '-400%' })
				.to('.js-four-planet-3', { duration: 1, opacity: 1, y: '-520%' })
				.to(
					'.js-four-planet-3',
					{ duration: 1, opacity: 0, y: '-1120%' },
					'+=4'
			...
			tl.to('.js-four-planet-4', { duration: 1, opacity: 0, y: '0%' })
				.to('.js-four-planet-4', { duration: 1, opacity: 0.5, y: '-400%' })
				.to('.js-four-planet-4', { duration: 1, opacity: 1, y: '-520%' })
				.to(
					'.js-four-planet-4',
					{ duration: 1, opacity: 0, y: '-1120%' },
					'+=4'
	...
	return (
		<div
			className='four-section js-four-section'
			ref={sectionRef}
			style={sectionStyle}
		>
			<img
			...
			<div className='four-section__group four-section__group--g1 js-four-group-1'>
				<div className='four-section__container four-section__container--s1'>
					<div className='four-section__story js-four-story'>Story</div>
					<div className='four-section__row js-four-contain-1'>
						<div className='four-section__img four-section__img--s1'>
							<div className='four-section__img-wrap js-four-img-1'>
								<div className='four-section__img-main-1'>
									<img className='js-scale' src={img_1} alt='' />
								</div>
								<img
						...
						<div className='four-section__info four-section__info--s1 js-scale'>
							<div className='four-section__title title-h1 js-four-title'>
								In the mystical realm of Etena, where the fabric of reality is
								woven from the threads of Etena Dust
							</div>
							<div className='four-section__text js-four-text-1'>
								<p>
									A pixelated essence vital for life itself, two ethereal
									species thrived: the enigmatic Angels and their counterparts,
									the Demons.
								</p>
								<p>
									Etena was a utopia, a testament to harmony and unity, until
									the fateful discovery that Etena Dust could be wielded for
					...
					<div className='four-section__row four-section__row-2'>
						...
						<div className='four-section__info four-section__info--s2 js-scale'>
							<div className='four-section__text js-four-text-2'>
								<p>
									The peaceful coexistence was shattered. Angels and Demons,
									once allies in the stewardship of Etena, diverged on their
									philosophies of Etena Dust’s use.
								</p>
								<p>
									This divergence sparked a cataclysmic battle, scattering the
									inhabitants & consuming the Etena Dust to near extinction. The
									aftermath was a world fractured, its legendary inhabitants
									lost to myth, and the once abundant Etena Dust a rare relic of
									the past.
								</p>
							</div>
						</div>
					...
					<div className='four-section__row js-four-contain-3'>
						<div className='four-section__info four-section__info--s3 js-scale'>
							<div className='four-section__subtitle js-four-subtitle'>
								<p>
									In the shadows of a world recovering from its own greed and
									violence, the Demons sensed a stirring, the faint whispers of
									Etena Dust rekindling.
								</p>
								<p>
									Amidst this resurgence, three clans of Demons emerged, ready
									to claim their stake in the rebirth of their world.
								</p>
							</div>
						</div>
					</div>
					...
					<div className='four-section__planets'>
						<div className='four-section__planet js-four-planet-1'>
							...
							<div className='four-section__planet-wrap'>
								...
								<div className='four-section__planet-text'>
									Masters of fire, embody the ferocity and unyielding power of
									volcanic eruptions. Their essence is one with the molten fury
									of Etena, a clan where passion and strength burn eternal.
								</div>
							</div>
						</div>
						<div className='four-section__planet js-four-planet-2'>
							...
							<div className='four-section__planet-wrap'>
								...
								<div className='four-section__planet-text'>
									Weavers of cosmic energies, embody the vastness and mystery of
									the universe. They navigate the space between stars,
									harnessing the celestial power to bend the fabric of reality
									itself.
								</div>
							</div>
						</div>
						<div className='four-section__planet js-four-planet-3'>
							...
							<div className='four-section__planet-wrap'>
								...
								<div className='four-section__planet-text'>
									guardians of water, embody the depth and adaptability of the
									ocean. Their spirits flow with the grace and relentless force
									of the tides, a clan as nurturing as it is formidable.
								</div>
							</div>
						</div>
